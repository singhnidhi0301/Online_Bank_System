...
throws ServletException,IOException	 
{
	try
	{
		...
		ResultSet rt=null;
	 	...
	 	query.append("update account_holder set balance=balance+").append(html_deposit_amount);
	 	query.append(" where accno=").append(html_accno);
	 	
	 	st.executeUpdate(query.toString());
	 	
	 	query.delete(0,query.length());
	 	query.append("insert into transcation (accno,date,time,deposite,withdraw,remark)");
