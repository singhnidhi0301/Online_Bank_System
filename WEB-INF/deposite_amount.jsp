...
function search_accno()
{
	try
	{
		...
		if(accno.length==0)
		return false;
		var url="deposite_amount?accountno_to_search="+accno;
...
<input type="text" value="" name="new_deposit_amount" id="new_deposit_amount" maxlength="5">
</td>
</tr>
<tr>
...
<tr>
<td align="left" valign="top">
<input type="button" value="proceed" onClick="deposite_amount()"></td>
</tr>
</table>
<script type="text/javascript">
function deposite_amount()
{
	try
	{
...
function handleServerResponse_deposite()
{
	try
	{
		if(xmlhttp.readyState==4)
